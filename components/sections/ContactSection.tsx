  ...
  return (
    <section className="bg-charcoal pt-16 px-6 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        {/* Title */}
        <div className="font-kyiv text-body mb-20  md:text-[60px] md:leading-18 lg:text-title lg:leading-20 text-white md:text-end text-left px-10 md:px-20">
          ANY QUESTIONS?
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 items-start">
          ...
          <div className="flex flex-col gap-6">
            <p className="text-white text-body leading-relaxed text-left md:text-right pl-10 md:pl-20 ">
